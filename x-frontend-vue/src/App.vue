...
<template>
  <main
    class="bg-stone-900 min-h-screen flex items-center justify-center flex-col p-20"
  >
    <div
      class="rounded-md border border-stone-700 text-white bg-stone-800 p-6 mx-auto w-full max-w-[600px]"
    >
